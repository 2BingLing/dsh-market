	...
	factory: (require) => {
		...
		*/
		...
		function InstallModal(props) {
			...
			}, security ? "开启：AI 安装前扫描（危险命令/信息收集/配置篡改/来源），发现风险即中止，不直接安装" : "关闭：快速安装（零 LLM 直装优先）")), security ? El("p", {
